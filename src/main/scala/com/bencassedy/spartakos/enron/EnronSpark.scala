...
object EnronSpark extends App {
  implicit val config = EnronConfig("EnronSpark")
...
//    val rescaledTrainingData: Dataset[(String, Vector)] = rescaleData(training)
//    val rescaledTestData: Dataset[(String, Vector)] = rescaleData(test)
//
